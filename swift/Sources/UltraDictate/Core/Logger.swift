// UltraDictate — push-to-talk dictation for macOS Apple Silicon.
// Core / Logger.swift
...
// across an abrupt exit) and to ~/Library/Logs/UltraDictate.log.

final class Logger: @unchecked Sendable {
    static let shared = Logger()
    private let url: URL
    private let q = DispatchQueue(label: "UltraDictateLogger")
    ...
    init() {
        ...
        url = logs.appendingPathComponent("UltraDictate.log")
    }
...
func privacySafeBundlePath(_ path: String) -> String {
    switch path {
    case "/Applications/UltraDictate.app", "/tmp/UltraDictate-dev.app",
         "/Applications/SuperDictate.app", "/tmp/SuperDictate-dev.app":
        return path
    default:
