// UltraDictate — high-performance, private push-to-talk dictation for macOS Apple Silicon.
...
let GITHUB_LATEST_RELEASE_URL = URL(string: "https://api.github.com/repos/m0rvey/ultradictate/releases/latest")!
let GITHUB_REPOSITORY_PAGE = URL(string: "https://github.com/m0rvey/ultradictate")!
let GITHUB_RELEASES_PAGE = URL(string: "https://github.com/m0rvey/ultradictate/releases/latest")!
let GITHUB_UPDATE_MANIFEST_URL = URL(string: "https://raw.githubusercontent.com/m0rvey/ultradictate/main/update.json")!
let UPDATE_ARCHIVE_MAX_BYTES = 64 * 1024 * 1024
let HOMEBREW_CASK_TAP = "m0rvey/ultradictate"
let HOMEBREW_CASK_TOKEN = "m0rvey/ultradictate/ultradictate"
let HOMEBREW_CASK_INSTALLED_TOKEN = "ultradictate"
let INSTALLED_APP_BUNDLE_PATH = "/Applications/UltraDictate.app"
let AGENT_ARGUMENT = "--agent"
let AGENT_LABEL = "com.local.ultradictate.agent"
let APP_SUPPORT_DIR_NAME = "UltraDictate"
...
let UPDATE_HELPER_LOG_PATH = (NSHomeDirectory() as NSString)
    .appendingPathComponent("Library/Logs/UltraDictate-update.log")
let UPDATE_PROGRESS_ARGUMENT = "--update-progress"
let UPDATE_PROGRESS_APP_PREFIX = "UltraDictate-update-progress-"
...
let HOTKEY_CAPTURE_BEGIN_NOTIFICATION = Notification.Name("com.local.ultradictate.hotkey-capture-begin")
let HOTKEY_CAPTURE_END_NOTIFICATION = Notification.Name("com.local.ultradictate.hotkey-capture-end")
let SETTINGS_CHANGED_NOTIFICATION = Notification.Name("com.local.ultradictate.settings-changed")
...
let SETTINGS_SUITE = "com.local.ultradictate"
let CORRECTIONS_FILE_UTI = "com.local.ultradictate.corrections"
let CORRECTIONS_FILE_EXTENSION = "ultradictate-corrections"
let CORRECTIONS_FILE_NAME = "UltraDictate Corrections.\(CORRECTIONS_FILE_EXTENSION)"
